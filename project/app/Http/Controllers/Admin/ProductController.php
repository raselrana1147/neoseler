...
class ProductController extends Controller
{
    public function __construct()
    {
         $this->middleware('auth:admin');
          ...
          $this->middleware('superadmin',['only'=>['allProduct','admin_deactive_product','admin_low_stock_product','admin_out_stcok_product']]);
    ...
    { 
        ...
        public function stock_out_datatable(){

         $usernaame=Auth::guard('admin')->user()->username;
          $datas = Product::where('product_type','=','normal')
         ->where('pro_owner','=',$usernaame)
         ->where('stock','<=','0')
         ->orWhere('stock',null)
         ->orderBy('id','desc')
         ->get();
       ...
       public function stock_low_datatable(){
    ...
    {
        return view('admin.product.stock_out');
    }

     public function stock_low()
    {
        return view('admin.product.stock_low');
    }
    ...
    public function admin_deactive_product(){
       $datas = Product::where(['status'=>0])->get();
       return view('admin.product.admin_deactive_product',compact('datas'));
    }
    
    public function admin_low_stock_product(){
         $datas = Product::where('stock',"<=","5")
         ->where('stock',">","0")
         ->get();
        return view('admin.product.admin_stcok_low',compact('datas'));
    }

    public function admin_out_stcok_product(){
        $datas = Product::where('stock',"<=","0")
         ->orWhere('stock',NULL)
         ->get();
       return view('admin.product.admin_stock_out',compact('datas'));
    }
