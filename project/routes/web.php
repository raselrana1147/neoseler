...
Route::prefix('admin')->group(function() {
  ...
  Route::get('/order_commission', 'Admin\MerchantHistory@order_commission')->name('admin.order.commission');
  ...
  Route::post('send-message', 'Admin\UserController@send_message')->name('send.message.all-user');
  Route::post('single-phone-message', 'Admin\UserController@single_message')->name('send.user.message');
   // merchant part
   ...
   Route::get('/merchant/reject-application','Admin\Merchant\MerchnatController@reject_marchant')->name('merchant.reject.application');
   Route::get('/merchant/reject-datatable','Admin\Merchant\MerchnatController@reject_datatable')->name('admin-merchant-reject');
   
   Route::get('merchant/pending-order', 'Admin\Merchant\MerchnatController@pending_order')->name('admin.merchant.pending.order');
   Route::get('merchant/processing-order', 'Admin\Merchant\MerchnatController@processing_order')->name('admin.merchant.processing.order');
   Route::get('merchant/completed-order', 'Admin\Merchant\MerchnatController@completed_order')->name('admin.merchant.completed.order');
   Route::get('merchant/ondelivery-order', 'Admin\Merchant\MerchnatController@ondelivery_order')->name('admin.merchant.ondelivery.order');
   Route::get('merchant/return-order', 'Admin\Merchant\MerchnatController@returned_order')->name('admin.merchant.return.order');
   Route::get('merchant/declined-order', 'Admin\Merchant\MerchnatController@declined_order')->name('admin.merchant.declined.order');
...
Route::post('change/api/{id}', 'Admin\GeneralSettingController@changeapi')->name('changeapi'); 
  ...
  Route::get('/orders/returned', 'Admin\OrderController@return')->name('admin-order-returned');
...
Route::get('/aorder/{id}/print', 'Admin\AffiliteOrderController@print')->name('aorder.print');
  ...
  Route::get('all/de-active-product', 'Admin\ProductController@admin_deactive_product')->name('admin-deactive-product');
   Route::get('all/stock/low-product', 'Admin\ProductController@admin_low_stock_product')->name('admin.low.stock.product');
  Route::get('all/stcok/out-product', 'Admin\ProductController@admin_out_stcok_product')->name('admin.stock.out.product');
  ...
  Route::get('/products/deactive', 'Admin\ProductController@deactive')->name('admin-prod-deactive');
     ...
     Route::get('/products/stcok_out', 'Admin\ProductController@stock_out')->name('admin-prod-stock-out');
   Route::get('/products/stcok_low', 'Admin\ProductController@stock_low')->name('admin-prod-stock-low');
   Route::get('/products/stock/datatables', 'Admin\ProductController@stock_out_datatable')
   ->name('admin-prod-stock-out-datatables');
   Route::get('/products/stock_low/datatables', 'Admin\ProductController@stock_low_datatable')
   ->name('admin-prod-stock-low-datatables');
  ...
  // -----------ADMIN AND MARCHANT LIVE CHAT SECTION
    Route::get('live-chat','Admin\LiveChatController@index')->name("live.chat");
...
Route::get('/delete-myshop/{id}', 'User\UserController@delete_myshop')->name('delete.item.myshop'); 
