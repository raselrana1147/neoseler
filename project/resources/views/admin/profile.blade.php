...
@section('content')
                        ...
                        @include('includes.admin.form-both')  
						                          ...
						                          <div class="col-lg-4">
						                           ...
						                           <div class="col-lg-7">
						                            <div class="img-upload">
						                                ...
						                                <div id="image-preview" class="img-preview" style="background-image: url('{{asset('assets/images/admins/'.$data->avatar)}}')">
                                                ...
                                                <div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __('Emergency Number') }} *</h4>
														</div>
													</div>
													<div class="col-lg-7">
														<input type="text" class="input-field" name="emergency_number" placeholder="{{ __('Emergency Number') }}" required="" value="{{$data->emergency_number}}">
													</div>
												</div>
