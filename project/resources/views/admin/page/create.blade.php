                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-page-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea  class=" summernote" name="details" placeholder="{{ __('Description') }}">{{ Request::old('details') }}</textarea> 
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <div class="text-editor">
                                <textarea name="meta_description" class="input-field summernote" placeholder="{{ __('Meta Description') }}"></textarea> 
                              </div>
                            </div>
                          </div>
                        </div>
