                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              {{-- <textarea class="nic-edit" name="details" >{{ $data->details }}</textarea> --}}
                               <textarea name="details" {{-- class="nic-edit-p" --}} class="summernote" placeholder="{{ __('Details') }}">{{ $data->details }}</textarea> 
                          </div>
                        </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <div class="text-editor">
                                 ...
                                 <textarea name="meta_description" class="summernote" placeholder="{{ __('Meta Description') }}">
