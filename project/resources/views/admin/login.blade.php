          ...
          <div class="col-lg-5">
            <div class="login-area">
              <div class="header-area">
               <h4 class="title">{{ __('Merchant Zone') }}</h4>
                <p class="text">Dont't have an account yet? <a href="{{ route('merchant.apply') }}">Sign Up</a></p>
              </div>
              <div class="login-form">
                ...
                <form id="loginform" action="{{ route('admin.login.submit') }}" method="POST">
                  ...
                  <div class="form-input">
                    <input type="text" name="phone" class="User Name" placeholder="{{ __('Type Phone Number') }}" value="" required="" autofocus>
