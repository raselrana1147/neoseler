...
@section('content')
	...
	<div class="panel panel-body">
		 <div class="panel panel-body" style="background-image: url('{{asset('assets/images/products/'.$data->photo)}}');background-size: contain">
				...
				<i class="icofont-upload-alt"></i> {{ __('Upload Image Here') }}
						                    ...
						                    <div class="{{ !empty($data->whole_sell_qty) ? "":"showbox" }}">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="special_com" step="1" type="number" class="input-field" placeholder="{{ __('e.g 20') }}" min="0" value="{{round($data->special_com)}}">
													</div>
												</div>
